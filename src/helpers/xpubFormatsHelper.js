...
const XPUB_DERIVATION_PATHS = {
    ...
    [BlockchainsEnum.BINANCE_SMART_CHAIN]: {
        [NetworksEnum[BlockchainsEnum.BINANCE_SMART_CHAIN]["NETWORK_BINANCE_SMART_CHAIN_MAINNET"]]: {
            [XPUB_DERIVATION_TYPE_BIP44]: "m/44'/60'/0'",
        },
        [NetworksEnum[BlockchainsEnum.BINANCE_SMART_CHAIN]["NETWORK_BINANCE_SMART_CHAIN_TESTNET"]]: {
            [XPUB_DERIVATION_TYPE_BIP44]: "m/44'/1'/0'",
        },
    }
};
...
const XPUB_DERIVATION_TYPES = {
    ...
    [BlockchainsEnum.BINANCE_SMART_CHAIN]: {
        [XPUB_DERIVATION_TYPE_BIP44]: (seed, network) => {
            let networkConfig = NetworksConfigsEnum[[BlockchainsEnum.BINANCE_SMART_CHAIN]][network];
           
            const rootKey = bip32.fromMasterSeed(seed, networkConfig.bip32);
            const derivationPath = XPUB_DERIVATION_PATHS[BlockchainsEnum.BINANCE_SMART_CHAIN][network][XPUB_DERIVATION_TYPE_BIP44];
            const accountXpriv = rootKey.derive(derivationPath);
